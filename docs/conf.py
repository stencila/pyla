...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('..', 'stencila')))
...
latex_documents = [
    (master_doc, 'pyla.tex', 'pyla Documentation',
     'Stencila and contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyla', 'pyla Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyla', 'pyla Documentation',
     author, 'pyla', 'One line description of project.',
     'Miscellaneous'),
]
